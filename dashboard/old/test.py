...
df_lat_lon = pd.read_csv(
    os.path.join(APP_PATH, os.path.join("data", "county_latlon.tab")),
    sep="\t"
)
...
# My token: pk.eyJ1IjoiamF5a2luemVyIiwiYSI6ImNrMnY5YjZsbzAycHAzZ28xNzlrZHM1NXAifQ.8mV40m2s-Azya4CsbpazPA
...
app.layout = html.Div(
    ...
    children=[
        html.Div(
            id="header",
            children=[
                html.H1(children="Opioid-Induced Deaths in the US"),
                html.P(
                    id="description",
                            ...
                            from poisonings in year {0}".format(
                                ...
                                dcc.Graph(
                                    ...
                                    figure=dict(
                                        data=[
                                            dict(
                                                lat=df_lat_lon["INTPTLAT"],
                                                lon=df_lat_lon["INTPTLONG"],
                                                text=df_lat_lon["NAME"],
                                                type="scattermapbox",
                                            )
                                        ],
                                        layout=dict(
